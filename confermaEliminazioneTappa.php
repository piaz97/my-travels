...
<body>
    ...
    <nav id="breadcrumb" aria-label="Breadcrumbs">
        ...
        <ol>
            ...
            <li>
                <a href="visualizza_itinerario.php?idItinerario=<?php echo $_POST['itinerarioId'];?>">
                    Visualizza itinerario <?php echo $_POST['itinerarioId'];?>
                </a>
            </li>
            <li>Eliminazione tappa #<?php echo $_POST["numeroTappa"]; ?></li>
        </ol>
    </nav>
    <div id="confermaContainer">
        <div id="contenutoPagina" class="sr-only"></div>
        <h1 >Sei sicuro di voler eliminare la tappa?</h1>
        <h2>Una volta eliminata la tappa non potrà più essere recuperata!</h2>
        <?php
        session_start();
        include_once ('funzioni.php');
        $itinerario = getTappaByIdAndNum($_POST['itinerarioId'], $_POST["numeroTappa"]);
        echo printTappa($itinerario, "elimina?",2);
        ?>
    </div>
