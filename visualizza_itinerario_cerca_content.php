...
<div id="rightTappa">
    ...
    stampaTappa($_GET['idItinerario'], 0);
    ?>
...
try {
    ...
    $query = $conn->prepare("SELECT Numero, Itinerario, Commento, Nome, Latitudine, Longitudine FROM Tappa WHERE Itinerario=:idItinerario");
    $query->bindParam(":idItinerario",$_GET['idItinerario']);
    $query->execute();
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBAKF6I6FaWFdnsDv6Rxxu6nxCQZNrTWaw&libraries=places&callback=initMap" async defer></script>